      ...
      <div className="mb-[10px] flex w-full items-center justify-between pt-[10px]">
        ...
        <div className="">
          <h2 className="text-base font-medium">
            ...
            <div className='flex-end flex flex-col item-center'>
              <div className='flex items-center justify-center'>
                <div className='flex h-[16px] px-[2px] py-[4px] items-center gap-[2px] rounded-[3px] border border-[#1384F5]'>
                  {/* <img className='w-[20px]' src={'https://blog.sui.io/content/images/2023/04/Sui_Droplet_Logo_Blue-3.png'} alt="" /> */}
                  <span className='text-xs text-[#1384F5] font-medium'>Testnet</span>
                </div>
              </div>
